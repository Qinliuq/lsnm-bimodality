...
#   Updated by Qin Liu on Mar. 20 2017: Some new modules have been added and embedded into the Virtual Brain.
#
    ...
    def run(self):
        ...
        for file in weight_files:
            with open(file) as f:
                ...
                whole_thing = whole_thing.replace(']2', '],2')
                whole_thing = whole_thing.replace(']3', '],3')
                whole_thing = whole_thing.replace(']-', '],-')
        ...
        for module in modules.keys():
            ...
            fs_synaptic.append(open('./output_2/' + module + '_synaptic.out', 'w'))
        ...
        numpy.save("./output_2/tvb_synaptic.npy", TVB_syna)
