# -*- coding: utf-8 -*-
"""
Created on Fri Dec 16 14:21:03 2016
...
#
#   This file (sim_pyqt5.py) was modified from sim_multi_item.py (which uses
#   pyqt4) to run with pyqt5.
#
#   Original author: Antonio Ulloa
#   Migrated from pyqt4 to pyqt5 by Qin Liu, Aug.17, 2017.
#
...
class LSNM(QtWidgets.QWidget):
    ...
    def initUI(self):
        ...
        uploadModelButton = QtWidgets.QPushButton('Model description file: ' + model, self)
        ...
        uploadWeightsButton = QtWidgets.QPushButton('Weights list file: ' + weights_list, self)
        ...
        uploadScriptButton = QtWidgets.QPushButton('Simulation script file: ' + script, self)
        ...
        neuralNetButton = QtWidgets.QPushButton('File containing neural net', self)
        ...
        # in simulation
        connectomeBox = QtWidgets.QCheckBox('Use TVB Connectome', self)
        ...
        runButton = QtWidgets.QPushButton('Run simulation', self)
        ...
        self.neuralNetTextEdit = QtWidgets.QLineEdit()
        ...
        newSubjectBox= QtWidgets.QCheckBox('Vary weights to create new subject', self)
    ...
    def browseModels(self):
        ...
        # of the network
        model = QtWidgets.QFileDialog.getOpenFileName(self, 'Select *.txt file that contains model', '.')[0]
    ...
    def browseWeights(self):
        ...
        weights_list = QtWidgets.QFileDialog.getOpenFileName(self, 'Select *.txt file that contains weights list', '.')[0]
    ...
    def browseScripts(self):
        ...
        # to be simulated
        script = QtWidgets.QFileDialog.getOpenFileName(self, 'Select *.txt file that contains script', '.')[0]
    ...
    def browseNeuralNets(self):
        ...
        # combined)
        neural_net = QtWidgets.QFileDialog.getOpenFileName(self, 'Select *.txt file that contains neural net', '.')
    ...
    def run(self):
        ...
        if useTVBConnectome == True:
            ...
            lsnm_tvb_link = {'ev1v': 345,
                         ...
                         'exss': 423,
                         'inss': 423,
            # gating modules are temperarily located in node 416/417, IT ROI
                         'exga':416,
                         'inga':416,
                         'exga_a':416,
                         'inga_a':416,
            ...
            # working memory modules
                         ...
                         'efd2': 41,
                         'ifd2': 41,
            # more working memory modules are inserted below
                         'efd1_a':73,
                         'ifd1_a':73,
                         'efd2_a':43,
                         'ifd2_a':43,
        ...
        if model == "" and weights_list == "":
            ...
            for file in weight_files:
                with open(file) as f:
                    ...
                    #print origin_module,destination_module
        ...
        for module in modules.keys():
            ...
            fs_neuronal.append(open('./output_2/' + module + '.out', 'w'))
            fs_abs_syn.append(open('./output_2/' + module + '_abs_syn.out', 'w'))
            fs_signed_syn.append(open('./output_2/' + module + '_signed_syn.out', 'w'))
                            ...
                            for w in modules[m][8][x][y][4]:
                                ...
                                if value_x_weight > 0:
                                    try:
                                        ...
                                        print 'stopped here \n'
                                        print modules[dest_module],'\n'
                                        print modules[dest_module][8][x_dest][y_dest]
                                else:
                                    try:
                                        modules[dest_module][8][x_dest][y_dest][2] += value_x_weight
                                    except:
        ...
        if useTVBConnectome == True:
            ...
            numpy.save("./output_2/tvb_neuronal.npy", TVB_elec)
            numpy.save("./output_2/tvb_abs_syn.npy", TVB_abs_syna)
            numpy.save("./output_2/tvb_signed_syn.npy", TVB_signed_syna)
