...
# -*- coding: utf-8 -*-
"""
Created on Thu Dec  7 13:28:14 2017
...
ax.plot(t, np.mean(eafr_a,axis=1))
ax.set_yticks([])
ax.set_ylim(0,1)
ax.set_xlim(0,timesteps)
plt.ylabel('FR_a', rotation='horizontal', horizontalalignment='right')
...
ax.plot(t, np.mean(eafr_b,axis=1))
ax.set_yticks([])
ax.set_ylim(0,0.4)
ax.set_xlim(0,timesteps)
plt.ylabel('FR_b', rotation='horizontal', horizontalalignment='right')
...
ax.plot(t, np.mean(eafr_s,axis=1))
ax.set_yticks([])
ax.set_ylim(0,1)
ax.set_xlim(0,timesteps)
plt.ylabel('FR_s', rotation='horizontal', horizontalalignment='right')
