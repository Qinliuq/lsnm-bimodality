# -*- coding: utf-8 -*-
"""
Created on Wed Sep 14 12:53:43 2016
...
plt.suptitle('Simulated synaptic activity vs. fMRI BOLD signal (V1)')

#v1
# Plot synaptic activities
plt.plot(t/20, syn[0]/400000, linewidth=2.0, color='black')
plt.plot(mr_time/20,v1_BOLD, linewidth=3.0, color='red',ls='--')
plt.gca().set_axis_bgcolor('white')

plt.figure()
plt.suptitle('Simulated synaptic activity vs. fMRI BOLD signal (V4)')
plt.plot(t/20, syn[1]/400000, linewidth=2.0, color='black')
plt.plot(mr_time/20, v4_BOLD, linewidth=3.0, color='red',ls='--')
plt.gca().set_axis_bgcolor('white')

# Set up separate figures to plot fMRI BOLD signal
plt.figure()
plt.suptitle('Simulated synaptic activity vs. fMRI BOLD signal (V4)')
plt.plot(t/20, syn[2]/400000, linewidth=2.0, color='black')
plt.plot(mr_time/20, it_BOLD, linewidth=3.0, color='red',ls='--')
plt.gca().set_axis_bgcolor('white')
...
plt.figure()
plt.suptitle('Simulated synaptic activity vs. fMRI BOLD signal (V4)')
plt.plot(t/20, syn[3]/400000, linewidth=2.0, color='black')
plt.plot(mr_time/20, d1_BOLD, linewidth=3.0, color='red',ls='--')
plt.gca().set_axis_bgcolor('white')
#plt.gca().set_axis_bgcolor('black')

plt.figure()
plt.suptitle('Simulated synaptic activity vs. fMRI BOLD signal (V4)')
plt.plot(t/20, syn[4]/400000, linewidth=2.0, color='black')
plt.plot(mr_time/20, d2_BOLD, linewidth=3.0, color='red',ls='--')
plt.gca().set_axis_bgcolor('white')
#plt.gca().set_axis_bgcolor('black')
