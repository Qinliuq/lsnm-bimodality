...
def balloon_function(y, t, syn):
    ...
    x = syn[np.floor(t * (synaptic_timesteps - 1) / T)]
...
state_ec = odeint(balloon_function, y_0_ec, t, args=(ec_syn,) )
state_pfc = odeint(balloon_function, y_0_pfc, t, args=(pfc_syn,) )
...
ec_BOLD = np.array(V_0 * (k1 * (1. - q_ec) + k2 * (1. - q_ec / v_ec) + k3 * (1. - v_ec)) )
pfc_BOLD = np.array(V_0 * (k1 * (1. - q_pfc) + k2 * (1. - q_ec / v_pfc) + k3 * (1. - v_pfc)) )
...
ec_BOLD = ec_BOLD[scanning_timescale]
pfc_BOLD = pfc_BOLD[scanning_timescale]
...
plt.plot(mr_time, v1_BOLD, linewidth=3.0, color='yellow', label='V1/V2')
...
plt.plot(mr_time, v4_BOLD, linewidth=3.0, color='green', label='V4')
#plt.gca().set_axis_bgcolor('black')

#plt.figure()
#plt.suptitle('SIMULATED fMRI BOLD SIGNAL IN IT')

plt.plot(mr_time, it_BOLD, linewidth=3.0, color='blue', label='IT')
plt.gca().set_axis_bgcolor('white')

#plt.figure()
#plt.suptitle('SIMULATED fMRI BOLD SIGNAL IN D1')

plt.plot(mr_time, d1_BOLD, linewidth=3.0, color='red', label='d1')
#plt.gca().set_axis_bgcolor('black')

plt.plot(mr_time, d2_BOLD, linewidth=3.0, color='pink', label='d2')
plt.gca().axes.xaxis.set_ticklabels([])
plt.gca().axes.yaxis.set_ticklabels([])
#plt.gca().set_axis_bgcolor('black')
legend = plt.legend(loc='lower right',fontsize='x-large')
plt.axvspan(0,700,color='gray')
plt.axvspan(1400,2100,color='gray')
plt.axvspan(2800,3500,color='gray')
...
plt.plot(mr_time, ec_BOLD, linewidth=3.0, color='red', label='EC')
#plt.gca().set_axis_bgcolor('black')

plt.plot(mr_time, pfc_BOLD, linewidth=3.0, color='pink', label='PFC')
plt.gca().axes.xaxis.set_ticklabels([])
plt.gca().axes.yaxis.set_ticklabels([])
#plt.gca().set_axis_bgcolor('black')
legend = plt.legend(loc='lower right',fontsize='x-large')
