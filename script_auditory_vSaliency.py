...
script_params = [0.0, 0.3, 0.05, 0.7, 0.02, [], []]
...
def delay_period(modules, script_params):
    ...
    modules['attna_a'][8][0][0][0] = script_params[2]
...
def intertrial_interval(modules, script_params):
    ...
    """
    for x in range(modules['ev4v'][0]):
        for y in range(modules['ev4v'][1]):
            modules['ev4v'][8][x][y][0] = script_params[0]
    for x in range(modules['ev4c'][0]):
        for y in range(modules['ev4c'][1]):
            modules['ev4c'][8][x][y][0] = script_params[0]
    for x in range(modules['ev4h'][0]):
        for y in range(modules['ev4h'][1]):
            modules['ev4h'][8][x][y][0] = script_params[0]
    # reset D1
