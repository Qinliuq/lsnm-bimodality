#!/usr/bin/python
#
# Script created on July 10 2017, by Antonio Ulloa,
...
def cross_shape(modules, script_params):
    ...
    modules['lgns'][8][3][4][0] = script_params[5]
    modules['lgns'][8][4][4][0] = script_params[5]
    modules['lgns'][8][5][4][0] = script_params[5]
    modules['lgns'][8][4][3][0] = script_params[5]
    modules['lgns'][8][4][5][0] = script_params[5]
