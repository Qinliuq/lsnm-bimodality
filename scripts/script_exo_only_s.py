...
def s2_up_01(modules, script_params):
    ...
    modules['mgns'][8][0][41][0] = script_params[2]
    modules['mgns'][8][0][42][0] = script_params[2]
...
def s2_up_02(modules, script_params):
    ...
    # the following stimulus is an up sweep
    modules['mgns'][8][0][42][0] = script_params[2]
    modules['mgns'][8][0][43][0] = script_params[2]
...
def s2_up_03(modules, script_params):
    ...
    # the following stimulus is an up sweep
    modules['mgns'][8][0][43][0] = script_params[2]
    modules['mgns'][8][0][44][0] = script_params[2]
...
def s2_up_04(modules, script_params):
    ...
    # the following stimulus is an up sweep
    modules['mgns'][8][0][44][0] = script_params[2]
    modules['mgns'][8][0][45][0] = script_params[2]
...
def s2_up_05(modules, script_params):
    ...
    # the following stimulus is an up sweep
    modules['mgns'][8][0][45][0] = script_params[2]
    modules['mgns'][8][0][46][0] = script_params[2]
...
def s2_up_06(modules, script_params):
    ...
    # the following stimulus is an up sweep
    modules['mgns'][8][0][46][0] = script_params[2]
    modules['mgns'][8][0][47][0] = script_params[2]
